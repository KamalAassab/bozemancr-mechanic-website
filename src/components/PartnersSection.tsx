    ...
    <section ref={ref} className="relative overflow-hidden z-20">
      ...
      <div className="relative z-10">
          ...
          >
            ...
            >
              <Image 
                ...
                height={200}
                quality={75}
                className="object-contain transition-all duration-150 group-hover:scale-110 group-hover:brightness-110 group-hover:contrast-110 group-hover:drop-shadow-2xl group-hover:drop-shadow-red-500/50"
              />
            </motion.div>
          </motion.div>
        ...
        <div className="hidden md:block relative h-[400px] flex items-center justify-center">
          {/* Audi - Left (Behind) */}
          <div className="absolute left-0 top-1/2 -translate-y-1/2 transform -rotate-12 z-10 group cursor-pointer">
            <Image 
              src="/images/vehicles/audi.jpg"
              alt="Audi"
              width={550}
          ...
          {/* Golf - Right (Behind) */}
          <div className="absolute right-0 top-1/2 -translate-y-1/2 transform rotate-12 z-10 group cursor-pointer">
            <Image 
              src="/images/vehicles/golf.jpg"
              alt="Golf"
              width={520}
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 transform rotate-1 group cursor-pointer">
            <Image 
              src="/images/vehicles/porsche.jpg"
              alt="Porsche"
              width={700}
