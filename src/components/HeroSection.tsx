...
import { Wrench, Zap, Calendar, Phone } from "lucide-react";
    ...
    <section ref={ref} id="hero" className="relative h-[60vh] flex items-center pt-20 z-20 md:min-h-screen">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mb-20">
          ...
          <motion.p 
            className="text-white text-base sm:text-lg md:text-xl lg:text-2xl mb-4 font-black italic tracking-wider ml-4 sm:ml-8 md:ml-12"
          ...
          <motion.div 
            className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start sm:items-center ml-4 sm:ml-8 md:ml-12 lg:ml-20"
            initial={{ opacity: 0, y: 30 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }}
          ...
          >
            <motion.a
              ...
              className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-primary via-primary to-primary/90 hover:from-primary/90 hover:via-primary hover:to-primary text-white font-condensed font-black italic text-sm sm:text-lg md:text-xl px-3 py-2 sm:px-4 sm:py-2.5 md:px-6 md:py-3 transition-all duration-150 transform hover:scale-105 shadow-2xl shadow-primary/40 border-2 border-primary/20 hover:border-primary/40 tracking-tight"
            ...
            >
              ...
              <motion.div 
                className="w-0 h-0 border-l-3 border-l-transparent border-r-3 border-r-transparent border-t-3 border-t-white sm:border-l-4 sm:border-r-4 sm:border-t-4"
            ...
            <motion.div 
              className="flex items-center gap-2 text-white/70 text-xs sm:text-sm font-condensed italic"
              initial={{ opacity: 0 }}
            ...
            >
              ...
              />
              <span>Montana's #1 Performance Shop</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
      ...
      >
        <div className="flex flex-row w-full gap-1">
          ...
          >
            ...
            <motion.div 
              className="relative z-10 transform group-hover:scale-105 transition-transform duration-150 flex flex-col items-center"
              whileHover={{ scale: 1.05 }}
            >
              <div className="flex flex-col items-center gap-1 mb-1 sm:flex-row sm:gap-3 sm:mb-2">
                <motion.div 
                  className="w-10 h-10 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-150 sm:hidden"
                ...
                <motion.div 
                  className="w-12 h-12 flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-150 hidden sm:flex"
                  whileHover={{ rotate: 5, scale: 1.1 }}
                >
                  <Image 
                    src="/icons/performance-hero.svg" 
                ...
                <motion.h3 
                  className="font-condensed font-black text-sm sm:text-xl group-hover:text-primary transition-colors duration-150 leading-tight tracking-tight"
                  whileHover={{ scale: 1.05 }}
                >
                  <span className="text-primary italic group-hover:text-white transition-colors duration-150">PERFORMANCE</span>
                  <span className="text-white italic group-hover:text-primary hidden sm:inline"> MODS</span>
                </motion.h3>
              </div>
              <motion.p 
                className="text-white/70 text-xs sm:text-sm group-hover:text-white/90 transition-colors duration-150 leading-tight text-center hidden sm:block"
            ...
            >
              <div className="flex flex-col items-center gap-1 mb-1 sm:flex-row sm:gap-3 sm:mb-2">
                ...
                <motion.h3 
                  ...
                  whileHover={{ scale: 1.05 }}
                >
                  <span className="text-primary italic group-hover:text-white transition-colors duration-150">REPAIRS</span>
            ...
            >
              <div className="flex flex-col items-center gap-1 mb-1 sm:flex-row sm:gap-3 sm:mb-2">
                ...
                <motion.h3 
                  ...
                  whileHover={{ scale: 1.05 }}
                >
                  <span className="text-primary italic group-hover:text-white transition-colors duration-150">MAINTENANCE</span>
