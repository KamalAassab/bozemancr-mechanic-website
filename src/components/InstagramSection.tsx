      ...
      >
        ...
        >
          <motion.a
            ...
            className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-condensed font-bold italic text-xl px-6 py-3 transition-all duration-300 transform hover:scale-105 rounded-full border-2 border-white/20 hover:border-white/40 shadow-2xl hover:shadow-purple-500/25 tracking-tight"
            whileHover={{ 
              scale: 1.05, 
              y: -3,
              transition: { duration: 0.3 }
          ...
          >
            ...
            <motion.div
              className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-600/20 to-pink-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              whileHover={{ scale: 1.1 }}
            />
            
            {/* Instagram icon with enhanced styling */}
            <motion.div
              className="relative z-10 flex items-center justify-center w-7 h-7 bg-white/20 rounded-full group-hover:bg-white/30 transition-colors duration-300"
              whileHover={{ rotate: 360, scale: 1.2 }}
              transition={{ duration: 0.3 }}
            >
            ...
            <motion.div
              className="absolute inset-0 rounded-full border-2 border-transparent bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
              style={{
